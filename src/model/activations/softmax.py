...
over multiple classes. It takes in a vector of values (usually logits)
and exponentiates each element to make them positive. Then, it divides
each exponentiated value by the sum of all exponentiated values,
ensuring the sum of all probabilities equals 1. This function is
commonly used as the output layer for multi-class classification
problems, where it outputs a probability distribution over mutually
